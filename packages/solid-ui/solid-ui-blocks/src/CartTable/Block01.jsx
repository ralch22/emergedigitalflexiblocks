...
const CartTable = ({ cartItems, increaseCartQuantity, decreaseCartQuantity, handleRemoveFromCart }) => {
    ...
    () => [
      ...
      },
      {
        ...
        Cell: ({ row }) => (
           <Box sx={{ display: "flex", flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center' }}>
            ...
            <FaPlus color="#fff" onClick={() => increaseCartQuantity(row.original.id)} />
            </Box>
            ...
            <FaMinus color="#fff" onClick={() => decreaseCartQuantity(row.original.id)} />
            </Box>
          </Flex>
           </Box>
        ),
      },
      {
        ...
        Cell: ({ row }) => (
            ...
            <FaTimes color="#fff" onClick={() => handleRemoveFromCart(row.original.id)} />
            </Box>
