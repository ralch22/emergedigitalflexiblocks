  ...
  reverse
    ...
    <Box sx={{ position: `relative` }}>
      ...
      <Box sx={{ textAlign: ['center', 'left'] }}>
        ...
        <VideoPlayer>
          <iframe width="555" height="312" src="https://www.youtube.com/embed/bDI_oXgb0EI" title="Natasha, your personal app builder" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </VideoPlayer>
        {buttons && (
          <Box sx={{ textAlign: [`center`, `left`] }}>
            <Divider space={3} />
